...
#define STRONG_TYPEDEF(T, D)                                                                                  \
    ...
    {                                                                                                         \
        typedef T base_type;                                                                                  \
        T t;                                                                                                  \
        constexpr explicit D(const T &value) BOOST_NOEXCEPT_IF(boost::has_nothrow_copy_constructor<T>::value) \
            : t(value) {}                                                                                     \
        D()                                                                                                   \
        BOOST_NOEXCEPT_IF(boost::has_nothrow_default_constructor<T>::value) : t() {}                          \
