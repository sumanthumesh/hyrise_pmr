 ...
 * pruned columns are not equal. When an LQPNode n1 is translated, the PQP deduplication reuses an operator that
...
{
  public:
    void apply_to_plan(const std::shared_ptr<LogicalPlanRootNode> &root_node,
