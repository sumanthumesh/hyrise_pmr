 ...
 * Besides the AbstractChunkIndex's positions list containing record positions for NULL values (`_null_positions`),
 ...
 */
class GroupKeyIndex : public AbstractChunkIndex
{
