...
class AnySegmentIterableTest : public BaseTestWithParam<SegmentEncodingSpec>
{
  public:
    static void SetUpTestCase()
    {
        ...
        auto row_ids =
            RowIDPosList{{ChunkID{0}, ChunkOffset{0}}, {ChunkID{0}, ChunkOffset{8}}, {ChunkID{0}, ChunkOffset{7}}, {ChunkID{0}, ChunkOffset{1}}, {ChunkID{0}, ChunkOffset{1}}, {ChunkID{0}, ChunkOffset{5}}};
